...
public class CadastroPessoaActivity extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_cadastro_pessoa, container, false);
            return rootView;
        }
    }
    ...
    public static class PlaceholderFragment2 extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.fragment_cadastro_pessoa_2, container, false);
            return rootView;
        }
    }
    ...
    public static class PlaceholderFragment3 extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.fragment_cadastro_pessoa_3, container, false);
            return rootView;
        }
    }
    ...
    public static class PlaceholderFragment4 extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.fragment_cadastro_pessoa_4, container, false);
            return rootView;
        }
    }
    ...
    public static class PlaceholderFragment5 extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.fragment_cadastro_pessoa_5, container, false);
            return rootView;
        }
    }
